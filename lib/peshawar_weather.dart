...
class PeshawarScreen extends StatefulWidget {
  const PeshawarScreen({super.key});

  @override
  State<PeshawarScreen> createState() => _PeshawarScreenState();
}

class _PeshawarScreenState extends State<PeshawarScreen> {

  String firstValue = "Peshawar";
  var dropDownItems = [
    "Karachi",
    "Lahore",
    "Islamabad",
  ...
  getApi() async {
    var url = Uri.parse("https://api.openweathermap.org/data/2.5/weather?q=peshawar,{country%20code}&appid=5d231ad57ebdf04883253c1dafa479e2");
