...
class _MultanScreenState extends State<MultanScreen> {
  ...
  getApi() async {
    var url = Uri.parse("https://api.openweathermap.org/data/2.5/weather?q=multan,{country%20code}&appid=5d231ad57ebdf04883253c1dafa479e2");
