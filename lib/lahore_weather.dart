...
class LahoreScreen extends StatefulWidget {
  const LahoreScreen({super.key});

  @override
  State<LahoreScreen> createState() => _LahoreScreenState();
}

class _LahoreScreenState extends State<LahoreScreen> {

  String firstValue = "Lahore";
  var dropDownItems = [
    "Karachi",
    "Lahore",
    "Islamabad",
  ...
  getApi() async {
    var url = Uri.parse("https://api.openweathermap.org/data/2.5/weather?q=lahore,{country%20code}&appid=5d231ad57ebdf04883253c1dafa479e2");
